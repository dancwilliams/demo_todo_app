defmodule DemoTodoAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DemoTodoAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DemoTodoAppWeb.Gettext, "errors", msg, opts)
    end
  end
